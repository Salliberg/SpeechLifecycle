...
comparison. Most prior reviews emphasize model architectures,
training strategies, capability taxonomies, or modality-specific
risks; none of the five reviews compared in
Table~\ref{tab:survey_comparison} combines benchmark meta-evaluation,
deployment analysis, speech-specific governance, and explicit
cross-stage coupling. The present survey inverts the usual framing.
It asks under which conditions the resulting systems can be trusted,
and it forces every section to be read through that lens.
...
capability catalog. Among the five reviews compared in
Table~\ref{tab:survey_comparison}, none conducts this form of
validity-oriented benchmark audit, and the resulting
evidence---17 capability dimensions,
...
validity} back into the discussion of Speech-LLM benchmarks. Drawing
on classical theories of construct validity---from the original
account in psychological testing \citep{cronbach1955construct} to its
unified score-meaning formulation \citep{messick1995validity}---and on
broader evaluation concerns surrounding ecological realism, evaluator
reliability, and operational deployment, we organize validity threats
into four survey-specific categories: construct, ecological,
evaluator, and operational. This adaptation extends
measurement-oriented reasoning to Speech-LLM benchmarking without
implying that all four categories originate from a single psychometric
framework. Language-technology evaluation has largely collapsed these
threats into a single question of
