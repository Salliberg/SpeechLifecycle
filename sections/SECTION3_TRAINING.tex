...
Align-SLM \citep{lin2025alignslmtextlessspokenlanguage} uses semantic
...
\midrule
\textbf{Annotation source} & Human preference pairs & Human preference pairs; some implementations mix synthetic data & AI-generated preference pairs & Speech requires acoustic + paralinguistic judgments; LLM judges are still moderate-correlation \citep{zheng2023judging} \\
\midrule
...
\midrule
\textbf{Speech adoption} & Limited (manual effort, slow iteration) & Promising: SpeechAlign, Align-SLM, OpenOmni & Emerging: RLAIF-V, Align-SLM & Adoption tracks the availability of speech-aware judges and benchmarks \\
\midrule
...
is similarly underdeveloped: text safety alignment does not
