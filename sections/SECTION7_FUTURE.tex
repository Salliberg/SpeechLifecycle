...
\begin{tabularx}{\textwidth}{p{0.20\textwidth}XXXXXX}
\toprule
\textbf{Survey} & \textbf{Training} & \textbf{Eval.\ meta-audit} &
\textbf{Deployment} & \textbf{Safety} &
\textbf{Coupling} & \textbf{Method} \\
\midrule
