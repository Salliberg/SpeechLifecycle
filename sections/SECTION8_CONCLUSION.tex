...
analyzed in Section~\ref{sec:evaluation_benchmarking} is a 2023--2026
snapshot (one benchmark from 2023 and 17 from 2024--2026); fifteen of
the eighteen benchmarks were arXiv preprints at the time of writing
and may have been peer-reviewed or superseded since. Claims that
depend on this corpus should therefore be read as time-bounded.
Second, the capability coding behind Figure~\ref{fig:benchmark_coverage_bar} was
